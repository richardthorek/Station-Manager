...
**Product name:** *Bushie Tools* is the customer-facing brand for this suite — see
the "Rebrand to Bushie Tools" item in `docs/MASTER_PLAN.md` (Commercialization &
coherence roadmap). The rebrand and this integration plan are one product story:
one approachable brand "for the average bushie," one login, one subscription.
