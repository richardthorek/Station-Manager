...
**2. A2 increment 2 — remaining** *(roster typeaheads on setup shipped Jun 21)*
- ✅ Station/member roster typeaheads on the AAR setup screen (`roster.js` + setup `<datalist>`s).
