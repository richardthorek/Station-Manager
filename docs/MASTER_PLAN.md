...
**Document Version:** 4.2 — AAR Studio direct-nav entitlement gate closed (fail-open plan probe on boot); AI gateway keys live; admin UX rough edges fixed
