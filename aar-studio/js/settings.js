  ...
  dialog.append(
    h('form', {
      ...
      h('p', { class: 'settings__note' },
        'By default AAR Studio uses this site’s built-in AI — you don’t need to enter anything here. ' +
        'These fields are an optional override: bring your own Azure OpenAI / Speech resource for local development or self-hosting. ' +
        'Anything you enter is stored in this browser’s localStorage only and sent directly to your Azure resources; leave the endpoint blank to use the built-in AI.'),
      h('h3', {}, 'Azure OpenAI (optional override)'),
      ...
      h('h3', {}, 'Azure AI Speech (optional override)'),
